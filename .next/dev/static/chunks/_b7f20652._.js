...
class ApiClient {
    ...
    async oauthCallback(params) {
        return this.request(`/auth/${params.provider}/callback`, {
            method: 'POST',
            body: JSON.stringify({
                code: params.code,
                state: params.state
    ...
    // 결제 준비
    async preparePayment(productIds) {
        return this.request('/api/payments/prepare', {
            method: 'POST',
            body: JSON.stringify({
                productIds
            })
                    ...
                    children: [
                        ...
                        token && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                    className: "text-xs text-blue-700 break-all font-mono",
                                    children: token
                                }, void 0, false, {
                                    fileName: "[project]/app/page.tsx",
                                    lineNumber: 85,
...
_s(Home, "zeps9Ekv0spgMiAtl8Y5d2FZTEw=", false, function() {
    return [
...
//# sourceMappingURL=_b7f20652._.js.map